...
// Firebase integration for CeamARQBCNApp project
export const environment = {
  production: false,
  firebase: {
    apiKey: "AIzaSyC5EqqrYWcILPt9Hwlf2xeNHjRolXCwv4I",
    authDomain: "cemarqbcnapp.firebaseapp.com",
    databaseURL: "https://cemarqbcnapp.firebaseio.com",
    projectId: "cemarqbcnapp",
    storageBucket: "cemarqbcnapp.appspot.com",
    messagingSenderId: "397997714865"
  },
  google_web_client_id: "397997714865-k1nkuqhn4gssjnrq09j55g07372vs3gg.apps.googleusercontent.com",
  facebook_app_id: 294884734661335,
  wordpress_url: 'https://wordpress.startapplabs.com/blog/',
  wordpress_rest_api_url: 'https://wordpress.startapplabs.com/blog/wp-json/wp/v2/'
};